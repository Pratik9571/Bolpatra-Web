    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Publisher Policy
            <Typography>
              POLICY FOR TENDER PUBLISHERS ON BOLPATRA NEPAL
            </Typography>
          </Typography>
        </Box>
      </Box>
      ...
      >
        ...
        <Typography variant="h6">
          Welcome to <strong>Bolpatra Group.</strong>
        </Typography>
        ...
        <ul>
          ...
          <li>
            This Policy for Tender Publishers on Bolpatra Nepal (
            <strong>"Policy"</strong>) sets forth the terms and conditions
            governing your use of the Website to publish tenders.
          </li>
          <li>
            By using our Website to publish tenders, you agree to the terms of
            this Policy.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>You must meet Terms & Conditions of Bolpatra Nepal.</li>
        </ul>

        <Typography variant="h5" sx={{ fontWeight: 800 }}>
          Tender Publishing Process
        </Typography>
        <ul>
          <li>
            Tender publishing on the Website is conducted in accordance with the
            rules and procedures set forth in the relevant tender publishing
            documents.
          </li>
          <li>
            You must comply with all the requirements and deadlines set forth in
            the tender publishing documents.
          </li>
          <li>
            {" "}
            We reserve the right to reject any tender publishing request that
            does not comply with the tender publishing documents or this Policy.
          </li>
        </ul>
        ...
        <ul>
          <li>
            You are solely responsible for the content of the tenders you
            publish on the Website.
          </li>
          <li>
            You represent and warrant that the content of the tenders does not
            violate any applicable laws or regulations, does not infringe any
            third-party rights, and is accurate and complete.
          </li>
          <li>
            You agree to indemnify and hold harmless the Company from any
            claims, damages, and expenses arising out of or in connection with
        ...
        <ul>
          <li>
            ...
            the Website, including but not limited to the content of the
            tenders, are owned by the Company or its licensors.
          </li>
          <li>
            You agree not to use, reproduce, or distribute any of the content on
            the Website without the prior written consent of the Company.
          </li>
        </ul>
